        ...
        <table>
          <tbody>
            <tr valign="TOP">
              ...
              <td>
                <h3>Project Admin - Pipeline</h3>
                <h4>Carimin-iDrill Joint Venture</h4>
                <ul>
                  <li>
                  ...
                  <li>
                    Expertly maintain company vehicle for optimal performance
                  ...
                  <li>
                    Create monthly progress videos, showcasing accomplishments
                    and objectives achieved within set timeline
                  </li>
                </ul>
              </td>
            </tr>
            ...
            <tr valign="TOP">
              ...
              <td>
                ...
                <ul>
                  <li>
                    Possess 8 months of professional experience working with
                    .NET, C#, and HTML5
                  </li>
                  <li>
                    Demonstrated problem-solving skills by reverse-engineering
                    an outdated user interface and identifying all relevant
                    fields, ultimately producing a set of UI templates
                  </li>
                  <li>
